...
SECRET_KEY = 'django-insecure-!q9r2l+kq8=oei39%6h*kh+bcz)3zad*!xc&u=q9ot$94@u0qy'
...
INSTALLED_APPS = [
    ...
    # REST framework and related packages
    'rest_framework',
...
# Email backend configuration (required for password reset email)
# EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # For console output during development
# For production, you might use an SMTP backend, e.g.:
